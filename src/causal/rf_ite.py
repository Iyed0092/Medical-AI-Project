...
def main(args):
    ...
    X_test1 = X_test.copy()
    X_test1['T'] = 1
    mu0 = rf.predict(X_test0)
    mu1 = rf.predict(X_test1)
    ite = mu1 - mu0
    ...
    import joblib
    joblib.dump(rf, out / "rf_ite_model.pkl")
    ...
    print("Saved RF ITE model and predictions to", out.resolve())
    print("Results:", results)

if __name__=="__main__":
    parser = argparse.ArgumentParser()
    from pathlib import Path
    parser.add_argument("--output_dir", type=Path, default="./experiments/rf_ite_run")
